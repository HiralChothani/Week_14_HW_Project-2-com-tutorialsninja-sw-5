...
public class LaptopsAndNoteBooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        assertAssert("Total is not Matching", laptopsAndNoteBooks.exptectedTextMessage("$1,204.00"), laptopsAndNoteBooks.actualTextToVerify(By.xpath("//div[@class = 'table-responsive']/table/tbody/tr/td[6]")));
