...
public class DesktopsTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully(){
        ...
        assertAssert("Invalid Date ", desktops.exptectedTextMessage("2022-11-30"), desktops.actualTextToVerify(By.xpath("(//small[contains(text(), '2022-11-30')])[2]")).substring(14,24));
        ...
        assertAssert("Price is incorrect", desktops.exptectedTextMessage("$122.00"), desktops.actualTextToVerify(By.xpath("//div[@class = 'table-responsive']/table/tbody/tr/td[6]")));
